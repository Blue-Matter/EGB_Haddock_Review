...
Please email tom@bluematterscience or failing that, adrian@bluematterscience for access to the repository. 
...
A full set of detailed diagnostics and model estimates are available in the form of the default wham report which is available [here](Base_Model/wham_output.html)
...
For more information about the OpenMSE software (Hordyk et al.) used in reference point calculation, projection and plan-B testing visit [the openMSE homepage](www.openMSE.com). 
